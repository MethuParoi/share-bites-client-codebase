...
const Testimonials = () => {
  return (
    <div
      className="xl:max-w-[1300px] mx-auto flex lg:flex-row items-center lg:gap-x-10 md:justify-around flex-col-reverse gap-y-6 lg:gap-y-0 py-16"
      id="donation-section"
    >
      <div className="w-[90vw] lg:w-[32vw]">
        ...
        <div className="flex justify-end items-center mt-5">
          <div className="flex flex-col items-end">
            <p className="text-gray-700 font-semibold mr-3 text-2xl">
              Ann Peterson
            </p>
            <p className="amatic-font text-secondary font-semibold text-3xl mr-3">
              Volunteer
            </p>
          </div>
          <img
