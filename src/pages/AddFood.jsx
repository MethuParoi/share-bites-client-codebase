...
const AddFood = () => {
  ...
  return (
    <div className="sm:p-6 p-2  mx-auto mb-10">
      ...
      {/* food form */}
      <div className="flex flex-col items-center p-8 space-y-6 bg-gray-200 dark:bg-primary rounded-lg shadow-xl md:w-[500px] mx-auto">
        <h2 className="text-3xl font-semibold text-center  mb-4 border-b-2 border-gray-400 w-[250px] mx-auto">
          Add Food
        </h2>
